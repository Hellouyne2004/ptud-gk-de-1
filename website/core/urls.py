...
urlpatterns = [
    ...
    path('my-blogs/', views.UserBlogListView.as_view(), name='user_blogs'),
    path('followed-blogs/', views.FollowedBlogsView.as_view(), name='followed_blogs'),
    # API
    ...
    path('api/follow-toggle/', api_views.FollowToggleAPIView.as_view(), name='follow-toggle'),
    # Authentication URLs
